      ...
      <div className="sideBar">
         ...
         <div className="sideBar__Des">
            <Description
               ...
               description="Puss in Boots: The Last Wish"
            />
            <Description
               header="Status"
            ...
            <Description
               header="Budget"
               description="$90,000,000.00"
            />
            <Description
               header="Revenue"
               description="$334,147,910.00"
            />
         </div>
         ...
         <div className="sideBar-top">
            ...
            <div className="leaders-list">
               ...
               <LeaderTop />
               <LeaderTop />
               <p className="view-more__link">
                  <a href="/movie/76600-avatar-the-way-of-water/changes">View Edit History</a>
               </p>
            </div>
         </div>
         ...
         <div className="popularity-trend">
            ...
            <div
               id="popularity_waypoint"
               className="popularity">
               <div
                  id="popularity_chart"
                  data-role="sparkline"
                  className=" k-sparkline"
                  ...
                  <span
                     ...
                     <svg
                        ...
                        <path
                           ...
                           fill="none"></path>
                        <path
                           d="M16.143 40.286 L 44.429 22.286 72.714 10.714 101 12 129.286 8.143 157.571 9.429 185.857 3"
                           stroke="#202020"
                           fill="none"></path>
                     </svg>
                  </span>
            ...
            <p className="button-collection">
               <a href="/collection/529892-black-panther-collection">edit page</a>
            </p>
         </div>
         <p className="view-more__link ">
            <a href="/movie/76600-avatar-the-way-of-water/changes">
               <FontAwesomeIcon icon={faKeyboard} /> Keyboard Shortcuts
            </a>
         </p>
         <p className="view-more__link">
            <a href="/movie/76600-avatar-the-way-of-water/changes">
               <FontAwesomeIcon icon={faCircleExclamation} /> Report an Issue
            </a>
         </p>
      </div>
   )
